...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2018 at 07:03 PM
...
(7, 'UX designer', 'Design UX', 1.50, 2, 3, '12356346', 'Kepong', 'AVAILABLE', 3, 1),
...
(3, 'client', 'client', '', 'client@gmail.co', '012030394', 'Client'),
(4, 'js', 'js', '', 'js@gmail.com', '34738473', 'Job Seeker');
...
--
ALTER TABLE `jobposition`
  MODIFY `jobID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
